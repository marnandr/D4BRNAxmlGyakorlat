...
public class DOMModifyD4BRNA {
    public static void main(String[] args) throws SAXException, IOException, ParserConfigurationException, TransformerConfigurationException, TransformerException {
        ...
        File xmlOutputFile = new File("XMLFeladatD4BRNA/DOMParseD4BRNA/src/hu/domparse/d4brna/XMLD4BRNAResults.xml");

        //  Scanner olvasó pédányosítása.
